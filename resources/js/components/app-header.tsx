...
const activeItemStyles =
    'text-foreground dark:text-foreground bg-warm-100 dark:bg-warm-800';
                                ...
                                {mainNavItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        {isCurrentUrl(item.href) && (
                                            <div className="absolute bottom-0 left-0 h-0.5 w-full translate-y-px bg-amber-accent"></div>
                                        )}
                                    </NavigationMenuItem>
                                ))}
                            </NavigationMenuList>
                                ...
                                >
                                    <Avatar className="size-8 overflow-hidden rounded-full">
                                        <AvatarImage
                                            ...
                                            alt={auth.user.name}
                                        />
                                        <AvatarFallback className="rounded-lg bg-warm-200 text-warm-700 dark:bg-warm-700 dark:text-warm-200">
